...
import YoadImg from "../../public/images/3.svg"; // עדכן את הנתיב של התמונה

const AboutMeSection = () => {
  return (
    <section className="bg-[#14213d] text-white py-12 px-6 md:px-20 flex flex-col md:flex-row items-center justify-between mx-auto w-4/5 md:w-full gap-8">
      {/* עיגול ותמונה */}
      ...
      <div className="flex-1 text-center md:text-right">
        ...
        <div className="flex mx-auto md:mx-0 justify-between items-center text-center md:w-4/5">
          {/* דיב ראשון */}
          <div className="flex-1 py-6 px-4  rounded-lg">
          ...
          {/* דיב שני */}
          <div className="flex-1 border-x border-[#e5e5e5] py-6 px-4">
            <h4 className="text-2xl md:text-3xl font-bold text-[#fca311]">
              10+
            </h4>
